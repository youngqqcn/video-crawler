...
class core:
    ...
    #
    # @return query object
    def query(self, query='', lang='en', orientation='all', perPage=200, order="latest", safeSearch=False, minWidth=1920, minHeight=1080, editorsChoice=False, category='all', colors='all'):
        param = params(
            host          = self.host,
            apiKey        = self.apiKey,
            query         = query,
